/**
 * Offline credential verification (SHA-256 via Web Crypto).
 * Used when the auth API is unreachable: local dev with Express down, or
 * static-host deployments (GitHub Pages / Netlify) with no backend.
 *
 * NOTE: the hashes ship in the client bundle. This is a UI gate, not real
 * security — use a long passphrase; Firestore rules still require Firebase auth.
 *
 * Configure in .env / CI secrets:
